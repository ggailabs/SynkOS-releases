...
Se estiver em um pane SynkOS, chame `pane_set_identity(paneId: SYNKO_PANE_ID, skill: "owasp-top-10", role: "qa")`.

Ao documentar findings de segurança, persista com:
```
wiki_ingest(sourceType: "manual", summary: "Security findings: ...", touchedPages: ["bugs"], content: "...")
```
