...
Se estiver em um pane SynkOS, chame `pane_set_identity(paneId: SYNKO_PANE_ID, skill: "architecture-decision-records", role: "architect")`.

Ao criar um ADR, persista no vault com:
```
vault_write(relPath: "adr/NNNN-title.md", content: "...")
wiki_ingest(sourceType: "adr", summary: "...", touchedPages: ["architecture"], content: "...")
```
